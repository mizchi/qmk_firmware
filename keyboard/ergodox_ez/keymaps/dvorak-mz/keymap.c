 ...
 * `--------+------+------+------+------+-------------'           `-------------+------+------+------+------+--------'
 *   |L1    |ESC/L1| LCTRL| LALT | LGUI |                                       | RGUI | RCTRL|   [  |   ]  | ~L1  |
 *   `----------------------------------'                                       `----------------------------------'
 *                                        ,-------------.       ,---------------.
...
[BASE] = KEYMAP(  // layer 0 : default
     ...
     LT(SYMB,KC_NO), LT(SYMB, KC_ESC), KC_LCTRL,   KC_LALT,  KC_LGUI,
        ...
        KC_NO,       KC_B,   KC_M,      KC_W,      KC_V,   LT(SYMB, KC_Z),   KC_RSFT,
                              KC_RGUI,  KC_RCTRL,  KC_LBRC,KC_RBRC,             KC_FN1,
 ...
 * |  RESET |      |      |      |      |      |      |           |      |      |      |      |      |      |        |
 * |--------+------+------+------+------+-------------|           |------+------+------+------+------+------+--------|
 * |        |      | Lclk | MsUp | Rclk |      |      |           |      |      | PGUP |  UP  | PGDN |      |        |
 * |--------+------+------+------+------+------|      |           |      |------+------+------+------+------+--------|
 * |        |      |MsLeft|MsDown|MsRght|      |------|           |------| BSPC | LEFT | DOWN |RIGHT |      |        |
 * |--------+------+------+------+------+------|      |           |      |------+------+------+------+------+--------|
 * |        |      | VolDn| Play | VolUp| Mute |      |           |      |      | HOME | ESC  | END  |      |        |
 * `--------+------+------+------+------+-------------'           `-------------+------+------+------+------+--------'
 *   |      |      |      | Lclk | Rclk |                                       |      |      |      |      |      |
 *   `----------------------------------'                                       `----------------------------------'
 *                                        ,-------------.       ,-------------.
...
KEYMAP(
       ...
       KC_TRNS, KC_TRNS, KC_VOLD, KC_MPLY, KC_VOLU, KC_MUTE, KC_TRNS,
    ...
    // right hand
       ...
       KC_TRNS,  KC_TRNS, KC_HOME, KC_ESC,  KC_END, KC_TRNS, KC_TRNS,
                          KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
       KC_TRNS, KC_TRNS,
       KC_TRNS,
